...
- (IndexedPlayerItem *)createPlayerItem:(NSString *)uri {
    ...
    // WetOwl: every item is offered to the equalizer, which does nothing with it
    // until it has been switched on at least once. See WetowlEq.m.
    [WetowlEq attachTo:item];
