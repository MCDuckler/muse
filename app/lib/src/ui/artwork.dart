...
/// A song's picture from what stats and history rows carry: a cover path when there is
/// one, and the song's printed sleeve when there is not.
class CoverByPath extends StatelessWidget {
  const CoverByPath({
    super.key,
    required this.id,
    required this.title,
